...
import '../../styles/SearchSymptoms.css'; // Import the CSS file
...
const SearchSymptoms = ({ open, closeModal, setSymptoms }) => {
    const [filteredSymptoms, setFilteredSymptoms] = useState(symptomsList);
...
>
            <Modal.Header />
            <Modal.Body className="relative overflow-hidden margin-top: 130px; ">
                <div className="sticky top-0 w-full bg-pink z-20">
                    <input
                ...
                <div className="symptom-list">
                    {filteredSymptoms.map((symptom, idx) => (
                        ...
                        >
                            <label onClick={(e) => e.stopPropagation()} htmlFor={`${symptom}-${idx}`} className="symptom-label">
                                {symptom}
                            </label>
                            <input
                                type="checkbox"
